...
public class PksCluster implements Serializable {
    ...
    public PksCluster(String name, String planName, String lastAction, String lastActionState, String lastActionDescription, String uuid, List<String> kubernetesMasterIps, Parameters parameters) {
        this.name = name;
